...
const Parallax = () => {
  return (
    <section className='h-screen md:h-[110vh] lg:h-[120vh] overflow-hidden '>
        ...
        <div className=" fixed top-0 -z-30 md:w-[35%] sm:w-[40%] w-[60%] h-screen dark:flex justify-end items-center text-2xl font-bold text-rose-500/80 hidden">
        ...
        <Image src={seaF} alt="" width={1000} height={1000} className="md:w-full md:h-auto absolute h-screen object-cover bg-center top-0 hidden dark:block" ></Image>
